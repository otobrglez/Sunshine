...
public class WeatherDataParserTest {
    ...
    @Test
    public void testMountainViewThirdDay() throws Exception {
        assertEquals(14.1, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, 2), 0.0);
    }

    @Test
    public void testFremontLastDay() throws Exception {
        assertEquals(16.75, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, 6), 0.0);
    }
    ...
    public void testGetWeatherDataFromJson() throws Exception {
        ...
        String r = results[0];
        assert r.contains("sky is clear");
    }
